...
export default function Service() {
  const services = [
    ...
    },
    {
      ...
      description: "Vom tropfenden Wasserhahn bis zur kompletten Badsanierung - unsere Experten kümmern sich um alle sanitären Anlagen in Ihrem Zuhause. Wir garantieren saubere Arbeit und höchste Kundenzufriedenheit.",
    },
    {
  ...
  return (
    <section className="page-content mx-auto px-4 md:py-24 bg-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center p-8">
          <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-[var(--text-color-secondary)] mb-4">
